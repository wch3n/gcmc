...
class ReactionStateVibrationWorkflow:
    ...
    def _base_output_row(record: dict[str, object], vib_dir: Path) -> dict[str, object]:
        ...
        return {
            ...
            "parent_o_candidate_id": metadata.get("parent_o_candidate_id", ""),
            "parent_state_dir": metadata.get("parent_state_dir", ""),
            "parent_state_candidate_id": metadata.get(
                "parent_state_candidate_id",
                "",
            ),
            "parent_candidate_id": metadata.get("parent_candidate_id", ""),
            "transition_builder": metadata.get("transition_builder", ""),
